...
<template>
  <div class="patient-detail space-y-4 pb-24 lg:pb-6">
    ...
    <template v-else-if="patient">
      ...
      <main class="w-full min-w-0">
        ...
        >
          ...
          <!-- Gallery tab content -->
          <template #gallery>
            <UCard :ui="{ root: 'max-h-[90vh] flex flex-col', header: { base: 'shrink-0' }, body: 'flex-1 min-h-0 overflow-y-auto', footer: { base: 'shrink-0' } }" class="mt-4">
    ...
    <UModal :ui="{ content: 'overflow-y-auto' }" v-model:open="isArchiveModalOpen">
      <template #content>
