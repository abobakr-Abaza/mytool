...
class NotificationService:
    ...
    async def test_smtp_settings(
        ...
        provider = SMTPProvider(
            ...
            default_from_name="LaminarDent",
        )

        # Send test email
        message = EmailMessage(
            to_email=to_email,
            subject="LaminarDent - Test de conexión SMTP",
            body_html="""
            <html>
    ...
    async def test_email_connection(to_email: str) -> EmailResult:
        ...
        message = EmailMessage(
            to_email=to_email,
            subject="LaminarDent - Test de conexión de email",
            body_html="""
            <html>
            <body style="font-family: sans-serif; padding: 20px;">
                <h2>¡Conexión exitosa!</h2>
                <p>Este es un email de prueba de LaminarDent.</p>
            ...
            """,
            body_text="¡Conexión exitosa! Este es un email de prueba de LaminarDent.",
        )
