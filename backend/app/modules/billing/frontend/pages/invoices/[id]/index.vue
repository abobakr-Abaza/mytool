    ...
    <template v-else>
      ...
      <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div class="lg:col-span-2 space-y-6">
          ...
          <UCard :ui="{ root: 'max-h-[90vh] flex flex-col', header: { base: 'shrink-0' }, body: 'flex-1 min-h-0 overflow-y-auto', footer: { base: 'shrink-0' } }" v-if="currentInvoice.invoice_payments && currentInvoice.invoice_payments.length > 0">
            <template #header>
              <h3 class="font-semibold text-default">
        ...
        <div class="space-y-6">
          ...
          <!-- Notes card -->
          <UCard :ui="{ root: 'max-h-[90vh] flex flex-col', header: { base: 'shrink-0' }, body: 'flex-1 min-h-0 overflow-y-auto', footer: { base: 'shrink-0' } }" v-if="currentInvoice.public_notes || currentInvoice.internal_notes">
            <template #header>
              <h3 class="font-semibold text-default">
                {{ t('invoice.notes') }}
              </h3>
