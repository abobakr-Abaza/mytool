...
def get_clinic_data() -> dict:
    ...
    return {
        ...
        "address": {
            ...
            "city": t({"es": "Madrid", "en": "Cairo", "fr": "Paris", "ar": "القاهرة"}),
            "postal_code": t({"es": "28013", "en": "11511", "fr": "75001", "ar": "11511"}),
            "country": t({"es": "España", "en": "Egypt", "fr": "France", "ar": "مصر"}),
        },
        "phone": t({"es": "+34 912 345 678", "en": "+20 100 123 4567", "fr": "+33 1 23 45 67 89", "ar": "+20 100 123 4567"}),
        "email": "info@demo.clinic",
        "currency": t({"es": "EUR", "en": "EGP", "fr": "EUR", "ar": "EGP"}),
        "timezone": t({"es": "Europe/Madrid", "en": "Africa/Cairo", "fr": "Europe/Paris", "ar": "Africa/Cairo"}),
        "settings": {
...
USERS_I18N = {
    "admin": {
        ...
        "ar": {"first_name": "مدير", "last_name": "تجريبي"},
    },
    "dentist": {
        ...
        "ar": {"first_name": "أحمد", "last_name": "عبد الله"},
    },
    "hygienist": {
...
def get_users_data() -> list[dict]:
    ...
    return [
        ...
        },
        {
            ...
            "professional_id": t({"es": "28/12345", "en": "DDS-12345", "fr": "DF-12345", "ar": "12345"}),
            "role": "dentist",
        ...
        },
        {
            ...
            "professional_id": t({"es": "28/54321", "en": "RDH-54321", "fr": "OEF-54321", "ar": "54321"}),
            "role": "hygienist",
