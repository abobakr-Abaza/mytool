...
Working notes for AI agents on LaminarDent.

## Project

LaminarDent — open-source dental clinic management software with a modular plugin architecture.
...
LaminarDent is built as independent modules under `backend/app/modules/<name>/` with matching Nuxt layers. Treat the boundary as a contract.
